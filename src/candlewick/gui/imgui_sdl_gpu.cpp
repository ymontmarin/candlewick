// CREDIT: https://github.com/ocornut/imgui/pull/7998
...
//  [X] Renderer: User texture binding. Use 'SDL_GPUTexture*' as ImTextureID.
//  Read the FAQ about ImTextureID! [ ] Renderer: Large meshes support (64k+
...
static uint32_t __glsl_shader_vert_spv[] = {
    ...
    0x736f5061, 0x00000000, 0x00030005, 0x0000001e, 0x004f4255, 0x00050006,
    ...
    0x00000000, 0x00040047, 0x0000000b, 0x0000001e, 0x00000000, 0x00040047,
    ...
    0x0000001e, 0x00000002, 0x00040047, 0x00000020, 0x00000022, 0x00000001,
    0x00040047, 0x00000020, 0x00000021, 0x00000000, 0x00020013, 0x00000002,
    ...
    0x00040020, 0x00000011, 0x00000003, 0x00000007, 0x0004002b, 0x0000000c,
    0x00000013, 0x00000001, 0x00040020, 0x00000014, 0x00000001, 0x00000008,
    0x0004003b, 0x00000014, 0x00000015, 0x00000001, 0x00040020, 0x00000017,
    0x00000003, 0x00000008, 0x0003001e, 0x00000019, 0x00000007, 0x00040020,
    0x0000001a, 0x00000003, 0x00000019, 0x0004003b, 0x0000001a, 0x0000001b,
    0x00000003, 0x0004003b, 0x00000014, 0x0000001c, 0x00000001, 0x0004001e,
    0x0000001e, 0x00000008, 0x00000008, 0x00040020, 0x0000001f, 0x00000002,
    0x0000001e, 0x0004003b, 0x0000001f, 0x00000020, 0x00000002, 0x00040020,
    0x00000021, 0x00000002, 0x00000008, 0x0004002b, 0x00000006, 0x00000028,
    0x00000000, 0x0004002b, 0x00000006, 0x00000029, 0x3f800000, 0x00050036,
    0x00000002, 0x00000004, 0x00000000, 0x00000003, 0x000200f8, 0x00000005,
    0x0004003d, 0x00000007, 0x00000010, 0x0000000f, 0x00050041, 0x00000011,
    0x00000012, 0x0000000b, 0x0000000d, 0x0003003e, 0x00000012, 0x00000010,
    0x0004003d, 0x00000008, 0x00000016, 0x00000015, 0x00050041, 0x00000017,
    0x00000018, 0x0000000b, 0x00000013, 0x0003003e, 0x00000018, 0x00000016,
    0x0004003d, 0x00000008, 0x0000001d, 0x0000001c, 0x00050041, 0x00000021,
    0x00000022, 0x00000020, 0x0000000d, 0x0004003d, 0x00000008, 0x00000023,
    0x00000022, 0x00050085, 0x00000008, 0x00000024, 0x0000001d, 0x00000023,
    0x00050041, 0x00000021, 0x00000025, 0x00000020, 0x00000013, 0x0004003d,
    0x00000008, 0x00000026, 0x00000025, 0x00050081, 0x00000008, 0x00000027,
    0x00000024, 0x00000026, 0x00050051, 0x00000006, 0x0000002a, 0x00000027,
    0x00000000, 0x00050051, 0x00000006, 0x0000002b, 0x00000027, 0x00000001,
    0x00070050, 0x00000007, 0x0000002c, 0x0000002a, 0x0000002b, 0x00000028,
    0x00000029, 0x00050041, 0x00000011, 0x0000002d, 0x0000001b, 0x0000000d,
...
static uint32_t __glsl_shader_frag_spv[] = {
    ...
    0x00000016, 0x00000022, 0x00000002, 0x00040047, 0x00000016, 0x00000021,
...
static void ImGui_ImplSDLGPU3_CreateRenderPipeline() {
  ...
  color_attachment_desc.blend_state.src_color_blendfactor =
      SDL_GPU_BLENDFACTOR_SRC_ALPHA;
  color_attachment_desc.blend_state.dst_color_blendfactor =
      SDL_GPU_BLENDFACTOR_ONE_MINUS_SRC_ALPHA;
  color_attachment_desc.blend_state.color_blend_op = SDL_GPU_BLENDOP_ADD;
  color_attachment_desc.blend_state.src_alpha_blendfactor =
      SDL_GPU_BLENDFACTOR_ONE;
  color_attachment_desc.blend_state.dst_alpha_blendfactor =
      SDL_GPU_BLENDFACTOR_ONE_MINUS_SRC_ALPHA;
  color_attachment_desc.blend_state.alpha_blend_op = SDL_GPU_BLENDOP_ADD;
  color_attachment_desc.format =
      SDL_GetGPUSwapchainTextureFormat(bd->Device, bd->Window);
...
static void ImGui_ImplSDLGPU3_SetupRenderState(
  ...
  // (0,0) for single viewport apps.
  {
    ...
    SDL_PushGPUVertexUniformData(command_buffer, 0, push_data,
                                 sizeof(float) * 4);
  }
}
...
void ImGui_ImplSDLGPU3_RenderDrawData(ImDrawData *draw_data,
  ...
  if (draw_data->TotalVtxCount > 0) {
    ...
    SDL_GPUTransferBuffer *transfer_buffer =
        SDL_CreateGPUTransferBuffer(bd->Device, &transfer_info);
    ...
    ImDrawIdx *idx_dst = reinterpret_cast<ImDrawIdx *>(
        reinterpret_cast<char *>(map) + vertex_size);
  ...
  ImGui_ImplSDLGPU3_SetupRenderState(draw_data, bd->Pipeline, cmd, render_pass,
                                     fb_width, fb_height);
    ...
    for (int cmd_i = 0; cmd_i < cmd_list->CmdBuffer.Size; cmd_i++) {
      ...
      if (pcmd->UserCallback != nullptr) {
        ...
        if (pcmd->UserCallback == ImDrawCallback_ResetRenderState)
          ImGui_ImplSDLGPU3_SetupRenderState(draw_data, bd->Pipeline, cmd,
                                             render_pass, fb_width, fb_height);
        else
...
bool ImGui_ImplSDLGPU3_CreateFontsTexture() {
  ...
  SDL_GPUTransferBuffer *transfer_buffer =
      SDL_CreateGPUTransferBuffer(bd->Device, &transfer_create_info);
  if (!transfer_buffer) {
